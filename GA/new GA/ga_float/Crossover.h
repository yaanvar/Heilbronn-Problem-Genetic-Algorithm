...
Individual crossover_roulette_wheell (Individual &parent1, Individual &parent2, std::vector <Individual> &population_temp, std::vector <double> &population_qualtity_temp) {
    int sz = parent1.gens.size();
    int x = -1, y = -1;
